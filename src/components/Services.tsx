    ...
    >
      ...
      <div className="p-8 flex flex-col flex-1 relative">
        <div className="flex justify-between items-start mb-6">
           ...
           <Link href={service.link} className="w-10 h-10 rounded-full border border-border/50 flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-300">
  ...
  return (
    <section id="services" className="py-24 sm:py-32 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        >
           <Link href="/services" className="inline-flex items-center text-muted-foreground hover:text-primary transition-colors font-medium group">
