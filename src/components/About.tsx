      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.h2 variants={fadeInUp as unknown as unknown as Variants} className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 tracking-tight">
              We don't sell "marketing". <br />
              <span className="text-primary">We install infrastructure.</span>
            </motion.h2>
            
            <motion.p variants={fadeInUp as unknown as unknown as Variants} className="text-muted-foreground text-lg mb-8 leading-relaxed max-w-xl">
            ...
            <motion.div variants={staggerContainer as unknown as unknown as Variants} className="space-y-4">
              {/* Feature 1: AI */}
              <motion.div 
          ...
          {/* Right content: The System Visualization */}
           <motion.div
              ...
              whileInView="visible"
              variants={fadeInUp as unknown as unknown as Variants}
              className="relative h-[350px] sm:h-[450px] lg:h-[600px] w-full flex items-center justify-center lg:translate-x-10"
            >
              ...
              {/* Scaled container for the orbiting system */}
              <div className="scale-[0.6] sm:scale-[0.75] lg:scale-100 relative w-full h-full flex items-center justify-center">
