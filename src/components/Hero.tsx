      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              AI-Powered <br />
              <span className="text-primary">Social Media.</span> <br />
              Web. Automation.
            </motion.h1>

            {/* Subtitle - keyword-rich with niche targeting */}
            <motion.p
              variants={fadeInUp as unknown as unknown as Variants}
              className="text-lg text-muted-foreground max-w-xl mb-8 leading-relaxed"
            >
              The AI-powered agency for coaches and educators. We build unified growth systems — social media management,
              conversion-focused web development, and intelligent automation agents that scale your business.
            </motion.p>
            ...
            >
              ...
              <motion.div variants={fadeInUp as unknown as unknown as Variants} className="flex items-center h-14">
                <Link
                  href="/services"
          ...
          >
            ...
            <div className="relative w-full max-w-[280px] sm:max-w-sm lg:max-w-md aspect-square">
               ...
               <motion.div
                 ...
                 className="absolute top-[10%] left-[0%] sm:left-[5%] p-3 sm:p-4 bg-card border border-border rounded-2xl shadow-xl backdrop-blur-sm z-10"
               >
               ...
               <motion.div
                 ...
                 className="absolute top-[10%] right-[0%] sm:right-[5%] p-3 sm:p-4 bg-card border border-border rounded-2xl shadow-xl backdrop-blur-sm z-10"
               >
                 <div className="flex items-center gap-3 mb-2">
               ...
               <motion.div
                 ...
                 className="absolute bottom-[6%] right-[0%] sm:right-[5%] p-3 sm:p-4 bg-card border border-border rounded-2xl shadow-xl backdrop-blur-sm z-10"
               >
                 <div className="flex items-center gap-3 mb-2">
               ...
               {/* Central Core */}
               <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 sm:w-32 sm:h-32 bg-card border border-primary/20 rounded-full flex items-center justify-center shadow-2xl z-0">
                  <div className="w-16 h-16 sm:w-24 sm:h-24 bg-primary/5 rounded-full flex items-center justify-center animate-pulse">
