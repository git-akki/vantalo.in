...
import { Brain, Zap, ShieldCheck, Heart, Users, Crosshair, Cpu, Linkedin, Instagram, Twitter, BookOpen, Newspaper } from "lucide-react";
    ...
    <div className="pt-24 pb-16 overflow-hidden">
      ...
      <section className="container relative z-10 mb-24 lg:mb-32 pt-12">
        ...
        >
           <div className="order-2 lg:order-1 text-left">
              <motion.div variants={fadeInUp as unknown as unknown as Variants} className="flex items-center gap-2 mb-6">
              ...
              <motion.h1
                ...
                className="text-3xl sm:text-5xl lg:text-7xl font-bold tracking-tight mb-6 leading-[1.1]"
              >
           ...
           <motion.div
             variants={fadeInUp as unknown as unknown as Variants}
             className="order-1 lg:order-2 relative h-[300px] sm:h-[400px] lg:h-[500px] flex items-center justify-center"
           >
              <div className="absolute inset-0 bg-primary/5 rounded-full blur-3xl transform scale-75" />

              <div className="relative w-full max-w-[260px] sm:max-w-sm lg:max-w-md aspect-square">
                 <motion.div
                   animate={{ rotate: 360 }}
                 ...
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 sm:w-32 sm:h-32 bg-card border border-primary/30 rounded-full flex items-center justify-center shadow-2xl z-20">
                    <Cpu className="w-8 h-8 sm:w-12 sm:h-12 text-primary" />
      ...
      <section className="container mb-24 lg:mb-32">
        ...
        >
           ...
           <motion.div variants={staggerContainer as unknown as unknown as Variants}>
              ...
              <motion.div variants={fadeInUp as unknown as unknown as Variants} className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                 <p>
                    We saw brilliant founders burning out. They had world-changing products but were stuck in the &quot;agency loop&quot;&mdash;hiring, firing, and hoping for a miracle.
                 </p>
                 <p>
                    We realized that <strong>&quot;hustle&quot; isn&apos;t a strategy. Systems are.</strong>
                 </p>
                 <p>
                    We didn&apos;t want to build another marketing firm that sells &quot;hours&quot; or &quot;deliverables&quot;. We set out to build a machine&mdash;a Growth OS&mdash;that turns ambition into predictable, scalable revenue.
                 </p>
              </motion.div>
           </motion.div>
        </motion.div>
      ...
      <section className="bg-secondary/5 py-24 border-y border-border/50 mb-24">
         <div className="container">
            ...
            >
               <motion.h2 variants={fadeInUp as unknown as unknown as Variants} className="text-3xl sm:text-4xl font-bold mb-6">The Era of Manual Growth is Over.</motion.h2>
               <motion.p variants={fadeInUp as unknown as unknown as Variants} className="text-muted-foreground text-lg">
      ...
      <section className="container mb-24 lg:mb-32">
         <motion.div
            ...
            className="text-center max-w-3xl mx-auto mb-16"
         >
            <motion.div variants={fadeInUp as unknown as unknown as Variants} className="flex justify-center mb-6">
               <Badge variant="outline" className="py-1.5 px-4 text-sm border-primary/20 bg-primary/5 text-primary rounded-full">
                 <Users className="w-3 h-3 mr-2" />
                 The Team
               </Badge>
         ...
         <motion.div
            ...
            className="relative"
         >
            <Link href="/about/akash-yadav" className="block">
              <div className="group relative bg-card border border-border/50 rounded-3xl overflow-hidden hover:border-primary/30 transition-colors duration-500">
                <div className="grid lg:grid-cols-5 gap-0">
                    ...
                    <div className="lg:col-span-3 p-6 sm:p-8 lg:p-12 flex flex-col justify-center relative">
                        <div className="mb-6">
      ...
      <section className="container mb-24">
         ...
         >
            ...
            <div className="order-1 lg:order-2 flex justify-center">
               <motion.div
                 variants={fadeInUp as unknown as unknown as Variants}
                 className="relative w-full max-w-[280px] sm:max-w-sm lg:max-w-md aspect-square"
               >
