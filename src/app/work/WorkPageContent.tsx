...
const ProjectCard = ({ project, className }: { project: typeof projects[0]; className?: string }) => {
  return (
    <Link href={`/work/${project.slug}`} className={cn("block h-full", className)}>
      <motion.div
          ...
          >
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                 <motion.div
                    ...
                    className="absolute z-20 w-36 sm:w-48 aspect-[3/4] bg-card border border-border rounded-xl shadow-2xl p-3 sm:p-4 flex flex-col gap-2"
                 >
                 ...
                 <motion.div
                    ...
                    className="absolute left-4 sm:left-10 top-4 sm:top-10 z-10 w-28 sm:w-40 aspect-[3/4] bg-card/80 backdrop-blur border border-border rounded-xl shadow-xl p-3 sm:p-4 flex flex-col gap-2 opacity-60"
                 >
                 ...
                 <motion.div
                    ...
                    className="absolute right-4 sm:right-10 bottom-4 sm:bottom-10 z-10 w-28 sm:w-44 aspect-[3/4] bg-card/80 backdrop-blur border border-border rounded-xl shadow-xl p-3 sm:p-4 flex flex-col gap-2 opacity-60"
                 >
                    <div className="w-6 h-6 rounded bg-secondary mb-2" />
                    <div className="w-full h-2 bg-secondary/50 rounded" />
